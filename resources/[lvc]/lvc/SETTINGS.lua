...
---------------MAIN SIREN SETTINGS-----------------
main_siren_settings_masterswitch = false
...
reset_to_standby_masterswitch = false
...
horn_on_cycle_masterswitch = false
...
custom_manual_tones_master_switch = false
