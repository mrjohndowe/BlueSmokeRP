...
Config.Shops = {
	...
	['police_shop'] = {
		...
		['Zone'] = {
            ...
            ['minZ'] = 39.00, -- min height of the shop zone
        ...
        ['ReturnLocation'] = vector4(-356.67, -160.71, 39.15, 30.99), -- Location to return vehicle, only enables if the vehicleshop has a job owned
        ['VehicleSpawn'] = vector4(-356.67, -160.71, 39.15, 30.99), -- Spawn location when vehicle is bought
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-327.64, -144.05, 38.65, 36.36), -- where the vehicle will spawn on display
			...
			[2] = {
                coords = vector4(-325.76, -138.81, 38.77, 37.99), -- where the vehicle will spawn on display
			...
			[3] = {
                coords = vector4(-324.07, -133.64, 38.72, 36.33), -- where the vehicle will spawn on display
			...
			[4] = {
                coords = vector4(-321.99, -128.53, 38.71, 36.55), -- where the vehicle will spawn on display
			...
			[5] = {
                coords = vector4(-318.61, -118.14, 38.55, 105.08), -- where the vehicle will spawn on display
			...
			[6] = {
                coords = vector4(-316.73, -113.03, 38.55, 104.62), -- where the vehicle will spawn on display
			...
			[7] = {
                coords = vector4(-313.9, -107.92, 38.59, 98.69), -- where the vehicle will spawn on display
			...
			[9] = {
                coords = vector4(-319.25, -123.66, 38.42, 70.23), -- where the vehicle will spawn on display
			...
			[10] = {
                coords = vector4(-347.3, -131.91, 38.78, 251.19), -- where the vehicle will spawn on display
			...
			[11] = {
                coords = vector4(-346.2, -124.74, 38.43, 250.86), -- where the vehicle will spawn on display
			...
			[12] = {
                coords = vector4(-341.49, -113.96, 38.8, 250.3), -- where the vehicle will spawn on display
			...
			[13] = {
                coords = vector4(-351.95, -90.35, 38.72, 250.05), -- where the vehicle will spawn on display
			...
			[14] = {
                coords = vector4(-369.54, -94.31, 39.44, 288.64), -- where the vehicle will spawn on display
			...
			[15] = {
                coords = vector4(-358.2, -97.74, 39.34, 35.51), -- where the vehicle will spawn on display
			...
			[16] = {
                coords = vector4(-365.24, -85.73, 39.37, 209.26), -- where the vehicle will spawn on display
			...
			[17] = {
                coords = vector4(-333.86, -96.65, 38.56, 205.27), -- where the vehicle will spawn on display
			...
			[18] = {
                coords = vector4(-342.62, -106.72, 38.53, 298.3), -- where the vehicle will spawn on display
			...
			[19] = {
                coords = vector4(-344.04, -93.13, 38.75, 198.07), -- where the vehicle will spawn on display
			...
			[20] = {
                coords = vector4(-339.19, -95.33, 38.71, 204.05), -- where the vehicle will spawn on display
			...
			[21] = {
                coords = vector4(-346.51, -105.0, 38.66, 299.59), -- where the vehicle will spawn on display
			...
			[22] = {
                coords = vector4(-351.22, -102.67, 38.77, 295.84), -- where the vehicle will spawn on display
			...
			[23] = {
                coords = vector4(-339.16, -162.41, 38.38, 293.43), -- where the vehicle will spawn on display
	...
	['police_shop_air'] = {
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-338.14, -102.68, 39.42, 255.86), -- where the vehicle will spawn on display
			...
			[2] = {
                coords = vector4(-337.57, -141.07, 39.42, 338.86), -- where the vehicle will spawn on display
                defaultVehicle = 'emsair', -- Default display vehicle
                chosenVehicle = 'emaair' -- Same as default but is dynamically changed when swapping vehicles
			},
			[3] = {
                coords = vector4(-332.38, -126.69, 38.92, 339.74), -- where the vehicle will spawn on display
			...
			[4] = {
                coords = vector4(-327.21, -109.61, 38.92, 160.51), -- where the vehicle will spawn on display
                defaultVehicle = 'aw139', -- Default display vehicle
                chosenVehicle = 'aw139' -- Same as default but is dynamically changed when swapping vehicles
			},
		}
