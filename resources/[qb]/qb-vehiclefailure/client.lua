...
CreateThread(function()
	while true do
		...
		if isPedDrivingAVehicle() then
			...
			if healthEngineCurrent == 500 then healthEngineLast = 1000.0 end
			...
			if healthBodyCurrent == 500 then healthBodyLast = 1000.0 end
			...
			if healthPetrolTankCurrent == 500 then healthPetrolTankLast = 1000.0 end
