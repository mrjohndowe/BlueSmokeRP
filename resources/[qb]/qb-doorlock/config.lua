...
Config.DoorList = {
	{
		...
		objCoords  = vector3(236.43, 231.75, 97.54),
		textCoords = vector3(236.43, 231.75, 97.54),
	...
	{
		objName = -2050208642,
		objCoords  = vec3(-100.241868, 6464.549316, 31.884604),
		textCoords = vec3(-100.241868, 6464.549316, 31.884604),
		objYaw = 225.11000061036,
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5
	...
	{
		objName = -2121568016,
		objCoords  = vec3(270.23, 221.27, 106.37),
		textCoords = vec3(270.23, 221.27, 106.37),
		authorizedJobs = { 'police' },
		objYaw = -20.0,
		locked = true,
		pickable = true,
	...
	{
		objName = -2121568016,
		objCoords  = vec3(267.37, 213.41, 106.37),
		textCoords = vec3(267.37, 213.41, 106.37),
		authorizedJobs = { 'police' },
		objYaw = -20.0,
		locked = true,
		pickable = true,
	...
	{
		objName = 'v_ilev_bk_vaultdoor',
		objCoords  = vec3(234.99, 228.07, 97.72),
		textCoords = vec3(234.99, 228.07, 97.72),
		authorizedJobs = { 'police' },
		objYaw = 90.0,
		locked = true,
		pickable = false,
