main = {
    ...
    detectionRadius = 60.0, -- This is the furthest distance you can be from a radar to activate it
...
locations = {
    {
		limit = 50.0,
		coords = vector3(248.3, -575.77, 43.31),
		heading = 165.21,
	},
	{
