...
MechanicWorkshop = { -- Mechanic Workshops where mechanics can use MechanicWorkshopAccess
    ...
    {coords = vector3(141.72, -3034.98, 7.04), radius = 30.0} -- NoPixel Bennys
...
['stock_tires'] = {
    label = "STANDARD", 
    usability = {exclusive = {}, vehicletypes = {}},
    traction = -0.04, -- Increasing this will make car make sharper turns
    width = 0.0,
    size = 0.0,
...
['michelin_tires'] = {
    label = "MICHELIN", 
    usability = {exclusive = {}, vehicletypes = {}},
   traction = 1.0, -- Increasing this will make car make sharper turns
    width = 0.0,
    size = 0.0,
    lowspeedtraction = -1.0, -- Increasing this will make the car spin out from low speeds
    durability = 30.0,
    repair = {
            ['rubber'] = {amount = 5, label = "Rubber", reusable = false}
        }
